...
{
    public class clsMarketplaceOrder
    {

        public void ProcessCart(clsMarketplaceCart ShoppingCart)
        {
            ...
            Int32 NewOrderNo;
            NewOrderNo = DB.Execute("sproc_tblMarketplaceOrder_Insert");
            ...
            while (Index < Count)
            {
                ...
                Int32 OrderNo = DB.Execute("sproc_tblMarketplaceOrderLine_Insert");
                Index++;
            }
