...
public class clsSecurity
{
    ...
    public string SignUp(string Username, string Password, string PasswordConfirm, string Secret)
    {
        ...
        if (Password == PasswordConfirm)
        {
            ...
            if (CheckPassword(Password) == "")
            {
                ...
                DB.Execute("sproc_tblVMUser_Insert");
            }
            else
            {
    ...
    public Boolean Login(string Username, string Password)
    {
        ...
        //execute the query
        UserAccount.Execute("sproc_tblVMUser_Login");
    ...
    public string ChangePassword(string Username, string Password1, string Password2, string Secret)
    {
        ...
        clsDataConnection UserAccount = new clsDataConnection();
        UserAccount.AddParameter("@UserName", Username);
        UserAccount.AddParameter("@SecretMessage", Secret);
        UserAccount.Execute("sproc_tblVMUser_CheckSecret");
        if (UserAccount.Count >= 1)
        {
