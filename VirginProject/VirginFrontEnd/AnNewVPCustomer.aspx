<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnNewVPCustomer.aspx.cs" Inherits="VirginFrontEnd.AnNewVPCustomer" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 1016px; top: 681px; position: absolute" Text="" Font-Bold="True" ForeColor="Black" Font-Size="Medium"></asp:Label>
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 808px; top: 703px; position: absolute; width: 61px;" Text="OK" Font-Bold= "True" ForeColor="Black" OnClick="btnOK_Click" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 892px; top: 703px; position: absolute" Text="Cancel" Font-Bold="True" ForeColor="Black" OnClick="btnCancel_Click" />


        <nav>
      
        <asp:Button ID="btnLogOut" runat="server" style="z-index: 1; left: 58px; top: 27px; position: absolute; height: 77px; width: 172px" Text="Log Out" Font-Bold="True" ForeColor="Black" OnClick="btnLogOut_Click" />
