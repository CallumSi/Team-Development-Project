...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApplyFilter" runat="server" style="z-index: 1; left: 218px; top: 232px; position: absolute" Text="Apply Filter" OnClick="btnApplyFilter_Click" />
        ...
        <asp:ListBox ID="lstMarketplaceListing" runat="server" style="z-index: 1; left: 220px; top: 288px; position: absolute; width: 305px; height: 115px"></asp:ListBox>
        ...
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 341px; top: 478px; position: absolute; right: 198px;" Text="Edit" OnClick="btnEdit_Click" />
