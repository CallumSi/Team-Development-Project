...
<body>
    <form id="form1" runat="server">
           <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 118px; top: 44px; position: absolute" Text="Favorited Listings"></asp:Label>
        ...
        <asp:Label ID="Label6" runat="server" style="z-index: 1; left: 122px; top: 170px; position: absolute; width: 111px;" Text="Suggested for you"></asp:Label>
           ...
           <asp:Button ID="btnRemoveFavorite" runat="server" OnClick="btnRemoveFavorite_Click" style="z-index: 1; left: 718px; top: 440px; position: absolute; margin-bottom: 0px" Text="RemoveFavorite" />
