...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 215px; top: 477px; position: absolute" Text="Add user" />
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 341px; top: 478px; position: absolute; right: 198px;" Text="Edit" />
