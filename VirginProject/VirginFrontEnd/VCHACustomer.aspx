...
<body>
    <form id="form1" runat="server" style="z-index: 1">
        ...
        <asp:Label ID="lblFirstName" runat="server" style="position: absolute; z-index: 1; left: 200px; top: 98px" Text="First Name:"></asp:Label>
        ...
        <asp:Label ID="lblDriverLicenseNumber" runat="server" style="z-index: 1; left: 200px; top: 245px; position: absolute; right: 110px;" Text="Driver's License Number:"></asp:Label>
        ...
        <asp:Label ID="lblUsername" runat="server" style="z-index: 1; left: 200px; top: 390px; position: absolute; bottom: 270px" Text="Username:"></asp:Label>
