...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblHireReturnDate" runat="server" style="z-index: 1; left: 200px; top: 295px; position: absolute; bottom: 270px" Text="Car Return Date:"></asp:Label>
        ...
        <asp:Label ID="lblHireStatus" runat="server" style="z-index: 1; left: 200px; top: 390px; position: absolute" Text="Hire Status:"></asp:Label>
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 200px; top: 450px; position: absolute" Text="Car and Customer identification data must pertain to active records, failure to supply correct data will result in the failure of system functionality."></asp:Label>
