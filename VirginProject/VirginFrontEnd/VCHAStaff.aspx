...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblStaffLastName" runat="server" style="z-index: 1; left: 10px; top: 150px; position: absolute" Text="Last Name:"></asp:Label>
        <asp:Label ID="lblStaffAddress" runat="server" style="z-index: 1; left: 10px; top: 195px; position: absolute" Text="Address:"></asp:Label>
        <asp:Label ID="lblStaffPostcode" runat="server" style="z-index: 1; left: 10px; top: 245px; position: absolute" Text="Postcode:"></asp:Label>
        <asp:Label ID="lblStaffUsername" runat="server" style="z-index: 1; left: 10px; top: 295px; position: absolute; bottom: 270px" Text="Username:"></asp:Label>
        <asp:Label ID="lblStaffEmail" runat="server" style="z-index: 1; left: 10px; top: 345px; position: absolute" Text="Email:"></asp:Label>
        <asp:Label ID="lblStaffPassword" runat="server" style="z-index: 1; left: 10px; top: 390px; position: absolute" Text="Password:"></asp:Label>
        <asp:Label ID="lblStaffPhoneNumber" runat="server" style="z-index: 1; left: 10px; top: 440px; position: absolute" Text="Phone Number:"></asp:Label>
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 8px; top: 495px; position: absolute" Text="[lblError]"></asp:Label>
