...
<head runat="server">
    <title>VCH - Car Delete Confirmation</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <section>
        <asp:Label ID="lblDeleteCar" runat="server" style="z-index: 1; left: 325px; top: 290px; position: absolute"  Text="Confirm deleting the selected Car" ForeColor="White"></asp:Label>
