...
<body>
    ...
    <div>
            <asp:Label ID="lblCars" runat="server" style="z-index: 1; left: 15px; top: 23px; position: absolute" Text="Cars"></asp:Label>
        </div>
        ...
        <asp:Label ID="lblCarModel" runat="server" style="z-index: 1; left: 15px; top: 365px; position: absolute" Text="Please Enter a Car model"></asp:Label>
        </p>
