...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblFirstName" runat="server" style="z-index: 1; left: 14px; top: 367px; position: absolute" Text="Please Enter a Customers First Name"></asp:Label>
        ...
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 142px; top: 539px; position: absolute" Text="Delete" />
