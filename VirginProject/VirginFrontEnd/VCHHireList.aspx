...
<body>
    <form id="form1" runat="server">
        <div>
        <asp:Label ID="lblHires" runat="server" style="z-index: 1; left: 15px; top: 23px; position: absolute" Text="Hires"></asp:Label>
        </div>
        ...
        <p>
        <asp:ListBox ID="lstHires" runat="server" Height="300px" Width="1250px" style="z-index: 1; left: 15px; top: 60px; position: absolute"></asp:ListBox>
        <asp:Label ID="lblHireLocation" runat="server" style="z-index: 1; left: 15px; top: 365px; position: absolute" Text="Please Enter a Virgin Car Hire Location"></asp:Label>
        </p>
