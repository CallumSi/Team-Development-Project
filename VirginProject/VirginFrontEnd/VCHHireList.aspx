...
<head runat="server">
    <title>VCH - Hire Requests List</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDisplayAll" runat="server" Height="40px" OnClick="btnDisplayAll_Click" style="z-index: 1; left: 400px; top: 485px; position: absolute;" Text="Display All Hires" />
