...
<head runat="server">
    <title>VCH - Staff Delete Confirmation</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <section>
        <asp:Label ID="lblDeleteStaff" runat="server" style="z-index: 1; left: 325px; top: 290px; position: absolute" Text="Confirm deleting the selected Staff" ForeColor="White"></asp:Label>
