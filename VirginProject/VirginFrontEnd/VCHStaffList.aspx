...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 77px; top: 540px; position: absolute; right: 1038px;" Text="Edit" OnClick="btnEdit_Click" />
        ...
        <asp:Label ID="lblUsername" runat="server" style="z-index: 1; left: 11px; top: 375px; position: absolute" Text="Please Enter a Staff Username"></asp:Label>
        </p>
