...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstVMCustomers" runat="server" BackColor="#EAE9F3" Font-Bold="True" style="z-index: 1; left: 170px; top: 152px; position: absolute; height: 187px; width: 523px"></asp:ListBox>
