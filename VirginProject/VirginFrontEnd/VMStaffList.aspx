...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtFilterStaffUsername" runat="server" BorderStyle="Solid" Font-Bold="True" style="z-index: 1; left: 354px; top: 102px; position: absolute; width: 211px"></asp:TextBox>
