...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" OnClick="btnApply_Click" style="z-index: 1; left: 27px; top: 445px; position: absolute; width: 86px" Text="Apply Filter" />
        <asp:Button ID="btnDisplayAll" runat="server" OnClick="btnDisplayAll_Click" style="z-index: 1; left: 133px; top: 445px; position: absolute" Text="DisplayAll" />
