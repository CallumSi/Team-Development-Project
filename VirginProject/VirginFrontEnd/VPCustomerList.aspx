...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCustomerList" runat="server" OnClick="btnCustomerList_Click" style="z-index: 1; left: 78px; top: 204px; position: absolute; height: 63px; width: 134px" Text="Customer List" />
        <asp:Button ID="btnStaffList" runat="server" OnClick="btnStaffList_Click" style="z-index: 1; left: 80px; top: 306px; position: absolute; height: 61px; width: 135px" Text="Staff List" />
