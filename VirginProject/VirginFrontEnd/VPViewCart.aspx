...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnPayment" runat="server" style="z-index: 1; left: 556px; top: 483px; position: absolute" Text="Continue to Payment" OnClick="btnPayment_Click" />
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 382px; top: 452px; position: absolute" Text="[lblError]"></asp:Label>
