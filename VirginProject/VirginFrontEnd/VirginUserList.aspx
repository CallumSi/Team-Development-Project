<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VirginUserList.aspx.cs" Inherits="VirginFrontEnd.VirginUserList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 134px; top: 368px; position: absolute" Text="Add" OnClick="btnAdd_Click" />
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 214px; top: 369px; position: absolute" Text="Edit" OnClick="btnEdit_Click" />
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 300px; top: 371px; position: absolute" Text="Delete" OnClick="btnDelete_Click" />
    </form>
</body>
</html>
